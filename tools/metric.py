...
class MetricsTop():
    ...
    def __eval_mosei_regression(self, y_pred, y_true, max_result=None):
        ...
        #     if non_zeros_acc2 > max_result['max_acc_2']:
        #         max_result['max_acc_2'] = non_zeros_acc2
        #     if non_zeros_f1_score > max_result['max_F1_score']:
        #         max_result['max_F1_score'] = non_zeros_f1_score
        #     if mult_a5 > max_result['max_Mult_acc_5']:
        #         max_result['max_Mult_acc_5'] = mult_a5
        #     if mult_a7 > max_result['max_Mult_acc_7']:
        #         max_result['max_Mult_acc_7'] = mult_a7
        #     if corr > max_result['max_Corr']:
        #         max_result['max_Corr'] = corr
        #     if mae < max_result['max_MAE']:
        #         max_result['max_MAE'] = mae

        eval_results = {
            # "Has0_acc_2":  round(acc2, 4),
            # "Has0_F1_score": round(f_score, 4),
            "acc_2": round(non_zeros_acc2, 7),
            "F1_score": round(non_zeros_f1_score, 7),
            "Mult_acc_5": round(mult_a5, 7),
            "Mult_acc_7": round(mult_a7, 7),
            "MAE": round(float(mae), 7),
            "Corr": round(corr, 7)
        }
        return eval_results

    def __eval_mosi_regression(self, y_pred, y_true, max_result=None):
        return self.__eval_mosei_regression(y_pred, y_true, max_result)

    def __eval_sims_regression(self, y_pred, y_true, max_result=None):
        test_preds = y_pred.view(-1).cpu().detach().numpy()
        test_truth = y_true.view(-1).cpu().detach().numpy()
        ...
        # if max_result is not None:
        #     if mult_a2 > max_result['max_acc_2']:
        #         max_result['max_acc_2'] = mult_a2
        #     if f_score > max_result['max_F1_score']:
        #         max_result['max_F1_score'] = f_score
        #     if mult_a5 > max_result['max_Mult_acc_5']:
        #         max_result['max_Mult_acc_5'] = mult_a5
        #     if mult_a3 > max_result['max_Mult_acc_3']:
        #         max_result['max_Mult_acc_3'] = mult_a3
        #     if corr > max_result['max_Corr']:
        #         max_result['max_Corr'] = corr
        #     if mae < max_result['max_MAE']:
        #         max_result['max_MAE'] = mae
